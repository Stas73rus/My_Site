		...
		<div id="site">
			...
			<div id="main">
					...
					<br/><br/>
						<div class="text1">
							<ul>
								<li><span>25 мая последний звонок.</span></li>
								<li><span>9 июня исполнилось 18 лет.</span></li>
								<li><span>9 июня экзамен по математике.</span></li>
								<li><span>25 июня получение аттестата об окончании лицея №45.</span></li>
								<li><span>Июль, подача заявлений на поступление в различные вузы: УЛГТУ, УЛГУ, УИ ГА.</span></li>
								<li><span>1 сентября начала учебы в УЛГТУ на факультете ФИСТ.</span></li>
								<li><span>15 ноября отметил с двоюродным братом его восемнадцатилетие.</span></li>
								<li><span>18 декабря день рождения у младшего брата.</span></li>
